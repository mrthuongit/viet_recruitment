...
.controller('QuestionVideoInterviewController', function($scope, $employer, $rootScope, localStorageService, $location, $common, $q, $cache, _, toastr, $translate)
{
    ...
    {
        if (!$scope.question_interview.$error.required )
        {
            localStorageService.set("interviewQuestionList", $scope.interviewQuestionList);
            localStorageService.set('interview', $scope.interview);

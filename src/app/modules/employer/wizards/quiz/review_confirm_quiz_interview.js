'use strict';
angular.module('employerModule').controller('ReviewConfirmQuizInterviewController', function($scope,
    $employer, $translate, $rootScope, localStorageService, $location,$q,_)
{
